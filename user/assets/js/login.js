...
//            $(".emailerror").hide();
            ...
            var promise=createUser(name,email,mobile,pass,damId);
...
function signIn(email,pass){
 var settings = {
  "async":true,
  "crossDomain":true,
  "url": "http://159.89.162.231:3000/user_registration/login?email="+email+"&password="+pass,
  "method": "POST"
 }
 return $.ajax(settings);
}

function createUser(name,email,mobile,pass,damId){
  var settings = {
  "async": true,
  "crossDomain": true,
  "url": "http://159.89.162.231:3000/user_registration/sign_up?email="
      +email+"&phone_number="+mobile+"&password="+pass+"&dam_id="+damId,
  "method": "POST"
  }
 return $.ajax(settings);
}
...
function loadDams(){
    var settings = {
  "url": "http://159.89.162.231:3000/user_home/dams",
  "method": "GET"
};
